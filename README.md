...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-25 18:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b0c49c31-bded-4e9b-8c59-b263c137cff9.git
$ cd b0c49c31-bded-4e9b-8c59-b263c137cff9
```
